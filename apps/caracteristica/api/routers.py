...
from apps.caracteristica.api.views.caracteristica_views import CaracteristicaUpdateViewSet, CaracteristicaViewSet
...
router.register(r'update',CaracteristicaUpdateViewSet, basename =  'updateCaracteristica-view')
