# Generated by Django 4.0.1 on 2022-03-04 15:28
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ImageField(blank=True, default='avataruni.png', max_length=255, null=True, upload_to='avatars/', verbose_name='Imagen de perfil')),
                ('estado', models.SmallIntegerField(default=1, null=True, verbose_name='Estado del usuario')),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.SmallIntegerField(blank=True, default=1, null=True, verbose_name='Staff')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.Group', verbose_name='groups')),
                ('unidadArea', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='unidadArea.unidadarea')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Nombres')),
                ('last_name', models.CharField(blank=True, max_length=255, null=True, verbose_name='Apellidos')),
                ('avatar', models.TextField(blank=True, default='avataruni.png', max_length=255, null=True, verbose_name='Imagen de perfil')),
                ('estado', models.SmallIntegerField(default=1, null=True, verbose_name='Estado del usuario')),
                ('is_active', models.BooleanField(default=True)),
                ('is_staff', models.SmallIntegerField(blank=True, default=1, null=True, verbose_name='Staff')),
